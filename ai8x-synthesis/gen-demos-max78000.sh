...
python ai8xize.py --test-dir $TARGET --prefix almond --checkpoint-file trained/ai85-almond-qat8-q.pth.tar --config-file networks/almond.yaml --sample-input demo.npy --overlap-data $COMMON_ARGS "$@"