...
def load_checkpoint(model, chkpt_file, optimizer=None,
    ...
    print(f"print this in the checkpoint.py for state_dict {checkpoint['state_dict'].keys()}")

    anomalous_keys = model.load_state_dict(checkpoint['state_dict'], strict= False)
    if anomalous_keys:
        # This is pytorch 1.1+
