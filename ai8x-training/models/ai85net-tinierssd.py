...
class TinierSSD(nn.Module):
    ...
    def __init__(self, num_classes,
        ...
        # print(f'in the tinierssd.py there is {num_classes} classes')
    ...
    def forward(self, image):
        ...
        locs, classes_scores = self.pred_convs(fire4_feats, fire8_feats, fire9_feats, fire10_feats,
                                               conv12_2_feats)
        # print(f'in the ai85net-tinierssd.py the class_Score {classes_scores}')
    ...
    def create_prior_boxes(aspect_ratios=default_aspect_ratios, device='cpu'):
        ...
        #prior boxes need to be changed to 2996--Josh.
    ...
    def detect_objects(self, predicted_locs, predicted_scores, min_score, max_overlap, top_k):
        ...
        # print(f'the number of batch size {batch_size}')
