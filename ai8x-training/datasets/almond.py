...
sys.path.append('/home/skim945/ECE189/ai8x-training')
sys.path.append('/home/skim945/ECE189/ai8x-training/data/ALMOND/processed')
import ai8x
# print(sys.path)
...
class ALMOND(Dataset):
    ...
    def __init__(self, root_dir, d_type, transform=None, img_size=(168, 224), fold_ratio=2,
        ...
        root_dir ='/home/skim945/ECE189/ai8x-training/data'
